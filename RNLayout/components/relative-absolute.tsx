...
export default function App(){
  return (
    ...
    <Box style={{backgroundColor:"blue",top:75,left:75}}>Deneme1 shrink</Box>
    <Box style={{backgroundColor:"green",}}>Deneme2 shrink</Box>
    <Box style={{backgroundColor:"pink",}}>Deneme3</Box>
    <Box style={{backgroundColor:"yellow",position:"absolute",top:100,left:100}}>Deneme4</Box>
